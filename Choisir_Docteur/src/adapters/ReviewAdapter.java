...
public class ReviewAdapter extends BaseAdapter implements ImageGetter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
	            ...
	            convertView = mInflater.inflate(R.layout.row_review_list, null);	
			...
			txttitle.setText(map.get("review"));
			...
			txtdate.setText(map.get("on_date"));
